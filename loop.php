	...
	<article <?php post_class(); ?>>
		...
		<div class="post-wrapper">
			...
			<aside>
				<ul>
					...
					<li><a href="<?php the_permalink(); ?>"><i class="fa fa-link"></i> &#8470; <?php the_ID(); ?></a>
					</li>
					<?php if (!is_page()) : ?>
						<li><a href="<?php comments_link(); ?>"><i
									class="fa fa-comments"></i> <?php comments_number('0 Responses', '1 Response', '% Responses'); ?>
							</a></li>
					<?php endif; ?>
				</ul>
			</aside>
		...
		<?php if (!is_page() && !is_archive() && !is_search()) : ?>
			<footer class="relative-nav">
				<span
					class="previous-nav"><?php next_post_link('%link', '<i class="fa fa-chevron-circle-left fa-4x"></i>'); ?></span>
				&nbsp;
				<span
					class="next-nav"><?php previous_post_link('%link', '<i class="fa fa-chevron-circle-right fa-4x"></i>'); ?></span>
			</footer>
